  ...
  return <QueryClientProvider client={queryClient}>
      ...
      <main className="relative min-h-screen overflow-hidden bg-gradient-to-b from-gray-100 via-gray-200 to-gray-100 dark:from-black dark:via-gray-900 dark:to-black p-4 md:p-8 transition-colors duration-200">
        ...
        <div className="relative flex flex-col items-center justify-center">
          <motion.button onClick={() => setIsContactFormOpen(true)} initial={{
            opacity: 0,
            y: -20
          }} animate={{
            opacity: 1,
            ...
            ease: "easeOut"
              ...
              focus:ring-offset-background pointer-events-auto select-none z-50 relative" role="button" tabIndex={0} aria-label="Open contact form to make an offer" onKeyDown={e => {
            ...
            <motion.div className="absolute inset-0 bg-gradient-to-r from-[#5841D8]/30 via-[#F2A900]/20 to-[#5841D8]/30 pointer-events-none" initial={{
              x: '-100%'
            }} animate={{
              x: '200%'
            }} transition={{
            ...
            <motion.div className="absolute -inset-px opacity-0 group-hover:opacity-100 transition-all duration-500
                bg-gradient-to-r from-[#5841D8] via-[#F2A900] to-[#5841D8] rounded-2xl" style={{
              mixBlendMode: 'overlay'
            }} />
            <motion.div className="absolute inset-0 bg-gradient-to-br from-[#5841D8]/5 to-[#F2A900]/5 opacity-0 group-hover:opacity-100" initial={{
              opacity: 0
            }} whileHover={{
              opacity: 1
            }} transition={{
            ...
            <motion.div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-r from-[#5841D8]/5 to-[#F2A900]/5" />
          </motion.button>
          <motion.h1 initial={{
            opacity: 0,
            y: -20
          ...
          <motion.h2 initial={{
            ...
            <Typewriter onInit={typewriter => {
              typewriter.typeString("Trade Smarter. Convert Faster. Stay Ahead in Crypto.").pauseFor(500).typeString(" All in Real-Time with Monday ").pauseFor(300).callFunction(() => {
